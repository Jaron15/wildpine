...
export default function MenuIcons({selections, toggleFilter}) {
  ...
  const icons = [
    { name: "Coffee", img: "/icons/coffeeiconB.png" },
    { name: "Tea", img: "/icons/teaiconB.png" },
    { name: "Energy", img: "/icons/edrinkiconB.png" },
  ...
  return (
    <div className="w-full  font-sans flex justify-center">
      <div className="flex overflow-x-scroll  scrollbar-hide space-x-4 px-4 py-6">
        {icons.map((icon) => (
          <div
            key={icon.name}
          ...
          >
<div
  className={`relative w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full flex items-center justify-center   ${
