...
export default function CustomCarousel() {
  ...
  return (
    <div className="carousel-container  mx-auto w-11/12 h-[30vh] xs:h-[32vh] ls:h-[35vh] ls:w-[80%] sm:h-[40vh] md:h-[23rem]
lg:h-[42.5rem] sm:w-[74%]  md:w-[36.5rem]  lg:w-[89%] xl:w-[70rem] 2xl:w-[111vh] 2xl:h-[69vh] ">
      <Swiper
